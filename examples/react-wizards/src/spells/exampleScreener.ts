  ...
  states: {
    ...
    questionVolume: {
      content: (ctx) => [
        ...
        { type: "button", text: "Less than 10", event: "NONE", attrs: { className: "xw--btn-sm" } },
        { type: "hr" },
        {
          type: "callout",
          content: [{ type: "small", text: `Wizard Score: ${ctx?.states?.wizardScore ?? 0}` }],
    ...
    developerExperience: {
      content: (ctx) => [
        ...
        },
        {
          ...
          attrs: { className: "xw--btn-inverted", target: "_blank" },
          event: "VIEW_OUTLINE",
        },
        { type: "hr" },
            ...
            true: [
              {
                ...
                attrs: { className: "xw--callout-warning" },
              },
            ],
          },
        },
            ...
            true: [
              {
                ...
                event: "INTERESTED",
                attrs: { className: "xw--btn-lg" },
              },
              {
                type: "buttonConfirm",
                text: ["Exit", "Confirm Exit"],
                event: "NOT_INTERESTED",
                attrs: { className: "xw--btn-sm xw--btn-inverted" },
              },
            ],
            false: [
              {
